...
baselines: `adr35_risk_tier_on_agentic_j2.json` (on-topic, 52 items, the
production flags as of ADR-35; `adr34_recmap_intent_on_agentic_j2.json` is the
run before the risk-tier framing, `adr32_recitals_on_agentic_j2.json` the run
before the recital map and `adr30_guard_on_agentic_j2.json` the 48-item run
before the recitals),
`risk_tier_adr35_on_j2.json` (risk-tier, flag on since ADR-35; `risk_tier_off_j2.json`
is the flag-off reference), `clarify_adr26_draw3_j2.json`
