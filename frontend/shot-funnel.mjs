  ...
  for (const theme of THEMES) {
    ...
    const chat = await page.evaluate((q) => {
      ...
      return {
        ...
        socialTurn: !!document.querySelector('[data-testid="social-turn"]'),
        socialHasNoCitationsOrCta: !document.querySelector('[data-testid="social-turn"]')?.parentElement?.querySelector('[data-testid^="assess-cta"], [data-testid="citations"]'),
        clarifyingTurn: !!document.querySelector('[data-testid="clarifying-turn"]'),
        clarifyingNoteHonest: /comes from the assessment/.test(text),
